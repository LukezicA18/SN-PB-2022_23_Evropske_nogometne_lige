...
matches = cur.execute("""select home_team_api_id, away_team_api_id, home_player_1, home_player_2, 
                            ...
                            home_player_X1, home_player_X2, home_player_X3, home_player_X4, home_player_X5, home_player_X6, home_player_X7, 
                            home_player_X8, home_player_X9, home_player_X10, home_player_X11, away_player_X1, away_player_X2, away_player_X3, 
